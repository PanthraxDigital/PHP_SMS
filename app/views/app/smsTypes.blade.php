                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text" class="form-control" value="{{$sms->sender}}" required name="sender" placeholder="school name,squadlLab">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text" class="form-control" required name="sender" placeholder="school name,squadlLab">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
